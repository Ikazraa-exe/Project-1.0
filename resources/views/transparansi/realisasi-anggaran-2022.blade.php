                            ...
                            <article class="article">
                                ...
                                <div class="container-header">
                                    <div class="title-container">
                                        <h2>Realisasi Anggaran Tahun 2022</h2>
                                    </div>
                                </div>
                                ...
                                <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="300">
                                    ...
                                    <div>
                                        <h4><a href="https://drive.google.com/file/d/1-5GpbWP87Cp_bAIL10sTVS2fWR-6hwzi/view"
                                                class="stretched-link">REALISASI ANGGARAN DIPA (01 BADAN URUSAN ADMINISTRASI MA RI TAHUN 2022)</a></h4>
                                <div style="text-align: center;" data-aos="fade-up" data-aos-delay="100">
                                    <img src="img/anggaran-2022.jpg" alt="" class="img-fluid">
                                </div>
                                ...
                                <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="300">
                                    <i class="bi bi-link-45deg flex-shrink-0"></i>
                                    <div>
                                        <h4><a href="https://drive.google.com/file/d/1dtVngWqU2W5d5Mp9TBJZP3uThY6YBzKJ/view"
                                                class="stretched-link">REALISASI ANGGARAN DIPA (05) DITJEN BADILMILTUN MA RI TAHUN 2022</a></h4>
           
                                <div style="text-align: center;" data-aos="fade-up" data-aos-delay="100">
                                    <img src="img/anggaran1-2022.jpg" alt="" class="img-fluid">
                                </div>
