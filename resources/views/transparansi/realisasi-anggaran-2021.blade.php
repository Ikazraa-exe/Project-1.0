                            ...
                            <article class="article">
                                ...
                                <div class="container-header">
                                    <div class="title-container">
                                        <h2>Realisasi Anggaran Tahun 2021</h2>
                                    </div>
                                </div>

                                <br>
                                <p><b>REALISASI ANGGARAN DIPA (01) BUA MARI TAHUN 2021</b></p>
                                <div style="text-align: center;" data-aos="fade-up" data-aos-delay="100">
                                    <img src="img/anggaran-2021.jpg" alt="" class="img-fluid">
                                </div>

                                <br>
                                <p><b>REALISASI ANGGARAN DIPA (05) DITJEN BADILMILTUN MARI TAHUN 2021</b></p>
                                <div style="text-align: center;" data-aos="fade-up" data-aos-delay="100">
                                    <img src="img/anggaran1-2021.jpg" alt="" class="img-fluid">
                                </div>
                            </article>
