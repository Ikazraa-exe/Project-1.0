                            ...
                            <article class="article">
                                ...
                                <div class="container-header">
                                    <div class="title-container">
                                        <h2>Putusan In Absentia Bulan Juni 2023</h2>
                                    </div>
                                </div>
                                ...
                                <div style="text-align: center;" data-aos="fade-up" data-aos-delay="100">
                                    <img src="img/absentia-juni.jpeg" alt="" class="img-fluid" style="max-width: 650px">
                                </div>
                                <br>
                                <div style="text-align: center;" data-aos="fade-up" data-aos-delay="100">
                                    <img src="img/absentia-juni1.jpeg" alt="" class="img-fluid" style="max-width: 650px">
                                </div>
                                <br>
                                <div style="text-align: center;" data-aos="fade-up" data-aos-delay="100">
                                    <img src="img/absentia-juni2.jpeg" alt="" class="img-fluid" style="max-width: 650px">
                                </div>
                                <br>
                                <div style="text-align: center;" data-aos="fade-up" data-aos-delay="100">
                                    <img src="img/absentia-juni3.jpeg" alt="" class="img-fluid" style="max-width: 650px">
                                </div>
                                <br>
                                <div style="text-align: center;" data-aos="fade-up" data-aos-delay="100">
                                    <img src="img/absentia-juni4.jpeg" alt="" class="img-fluid" style="max-width: 650px">
                                </div>
