                                ...
                                <div class="row">
                                    <div class="col-lg-12 mt-3 mt-lg-0 d-flex flex-column justify-content-center">
                                        <div class="icon-box d-flex position-relative" data-aos="fade-up"
                                            ...
                                            <div>
                                                <h4><a href="https://drive.google.com/file/d/1MNMvnu2iT2eKMkryBaNUeonxlhRpM3d8/view?usp=sharing"
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mt-3 mt-lg-0 d-flex flex-column justify-content-center">
                                        <div class="icon-box d-flex position-relative" data-aos="fade-up"
                                            ...
                                            <i class="bi bi-link-45deg flex-shrink-0"></i>
                                            <div>
                                                <h4><a href="https://drive.google.com/drive/folders/1IG07z8jw4TMe3wILChMbQI8JlQqlPrkg"
                                                        class="stretched-link"></a></h4>
                                                <h4 class="highlight" style="border-radius: 8px; font-size:13px">
                                                    Silahkan Klik disini untuk Dokumen Pengungkit Area 3 Penataan SDM Aparatur
                                                </h4>
                                            </div>
                                        ...
                                        <div class="icon-box d-flex position-relative" data-aos="fade-up"
                                            ...
                                            <i class="bi bi-link-45deg flex-shrink-0"></i>
                                            <div>
                                                <h4><a href="https://drive.google.com/drive/folders/1fVRxIevt1LuBJgFXNxM1ocCxY-GTkODO"
                                                        class="stretched-link"></a></h4>
                                                <h4 class="highlight" style="border-radius: 8px; font-size:13px">
                                                    Silahkan klik disini untuk mengunduh Dokumen Reform Area 3 Penataan SDM Aparatur
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
