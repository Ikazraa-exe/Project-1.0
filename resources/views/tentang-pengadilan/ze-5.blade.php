                                ...
                                <div class="row">
                                    <div class="col-lg-12 mt-3 mt-lg-0 d-flex flex-column justify-content-center">
                                        <div class="icon-box d-flex position-relative" data-aos="fade-up"
                                            ...
                                            <div>
                                                <h4><a href="https://drive.google.com/file/d/1m9CHowF2lcISZbF-dSPrVEAKomBjn_7j/view"
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mt-3 mt-lg-0 d-flex flex-column justify-content-center">
                                        <div class="icon-box d-flex position-relative" data-aos="fade-up"
                                            ...
                                            <i class="bi bi-link-45deg flex-shrink-0"></i>
                                            <div>
                                                <h4><a href="https://drive.google.com/drive/folders/1v75jQxuRquBYnxG5A2-QRtaNrV9SVAj6"
                                                        class="stretched-link"></a></h4>
                                                <h4 class="highlight" style="border-radius: 8px; font-size:13px">
                                                    Silahkan Klik disini untuk mengunduh Dokumen Pengungkin Area 5 Penguatan Pengawasan
                                                </h4>
                                            </div>
                                        ...
                                        <div class="icon-box d-flex position-relative" data-aos="fade-up"
                                            ...
                                            <i class="bi bi-link-45deg flex-shrink-0"></i>
                                            <div>
                                                <h4><a href="https://drive.google.com/drive/folders/1eYwVdg9GXi6HhMN2ZulrIE9djixyyrjy"
                                                        class="stretched-link"></a></h4>
                                                <h4 class="highlight" style="border-radius: 8px; font-size:13px">
                                                    Silahkan klik disini untuk mengunduh Dokumen Reform Area 5 Penguatan Pengawasan
                                            </div>
                                        </div>
                                    </div>
                                </div>
