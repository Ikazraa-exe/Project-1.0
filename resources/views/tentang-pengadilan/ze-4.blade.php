                                ...
                                <div class="row">
                                    <div class="col-lg-12 mt-3 mt-lg-0 d-flex flex-column justify-content-center">
                                        <div class="icon-box d-flex position-relative" data-aos="fade-up"
                                            ...
                                            <div>
                                                <h4><a href="https://drive.google.com/file/d/1wrGgYEmNtmDBvdV8jDkxGoztIr_zaCae/view?usp=sharing"
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mt-3 mt-lg-0 d-flex flex-column justify-content-center">
                                        <div class="icon-box d-flex position-relative" data-aos="fade-up"
                                            ...
                                            <i class="bi bi-link-45deg flex-shrink-0"></i>
                                            <div>
                                                <h4><a href="https://drive.google.com/drive/folders/1IItlVA8kLm5h6WefAA6qvwMoePatCbqy"
                                                        class="stretched-link"></a></h4>
                                                <h4 class="highlight" style="border-radius: 8px; font-size:13px">
                                                    Silahkan Klik disini untuk mengunduh Dokumen Pengungkit Area 4 Penguatan Akuntabilitas
                                                </h4>
                                            </div>
                                        ...
                                        <div class="icon-box d-flex position-relative" data-aos="fade-up"
                                            ...
                                            <i class="bi bi-link-45deg flex-shrink-0"></i>
                                            <div>
                                                <h4><a href="https://drive.google.com/drive/folders/1fVri0nZVPjdRiHI2guo-6bqUPDSiioWx"
                                                        class="stretched-link"></a></h4>
                                                <h4 class="highlight" style="border-radius: 8px; font-size:13px">
                                                    Silahkan klik disini untuk mengunduh Dokumen Reform Area 4 Penguatan Akuntabilitas
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
