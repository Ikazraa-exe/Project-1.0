                            ...
                            <article class="article">
                                ...
                                <div class="container-header">
                                    <div class="title-container">
                                        <h2>Profil Pegawai Teladan 2024</h2>
                                    </div>
                                </div>
                                ...
                                <div style="text-align: center;">
                                    <img src="img/pegawai-2024.jpg" alt="" class="img-fluid" style="max-width: 600px;"data-aos="fade-up" data-aos-delay="100">
                                  </div>

                                  <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="300">
                                    <i class="bi bi-link-45deg flex-shrink-0"></i>
                                    <div>
                                        <h4><a href="https://drive.google.com/file/d/1lJRlGhjChWcfg4Nn5Ph14354WVlFV4po/view" class="stretched-link">Tautan Link :</a></h4>
                                        <h4 class="highlight" style="border-radius: 8px; font-size:13px">KEPUTUSAN KEPALA PENGADILAN MILITER I-05 PONTIANAK NOMOR 41/KPM.W1-MIL05/SK.0T1.2/I/2024 TANGGAL 31 JANUARI 2024 TENTANG PENUNJUKAN PEGAWAI TELADAN PERIODE TAHUN 2024 PADA PENGADILAN MILITER I-05 PONTIANAK
                                        </h4>
                                    </div>
                                </div><!-- End Icon Box -->
                            </article>
