                            ...
                            <article class="article">
                                ...
                                <div class="container-header">
                                    <div class="title-container">
                                        <h2>Profil Pegawai Teladan 2023</h2>
                                    </div>
                                </div>
                                ...
                                <div style="text-align: center;">
                                    <img src="img/pegawai-2023.jpg" alt="" class="img-fluid" style="max-width: 600px;"data-aos="fade-up" data-aos-delay="100">
                                  </div>

                                  <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="300">
                                    <i class="bi bi-link-45deg flex-shrink-0"></i>
                                    <div>
                                        <h4><a href="https://drive.google.com/file/d/1YEkd_DPVF8iCQpPCG7uFQ6e-YjargC4B/view" class="stretched-link">Tautan Link :</a></h4>
                                        <h4 class="highlight" style="border-radius: 8px; font-size:13px">KEPUTUSAN KEPALA PENGADILAN MILITER I-05 PONTIANAK NOMOR W1-MIL05/KEP/42/KP.02.1/V/2023 TANGGAL 3 MEI 2023 TENTANG PENUNJUKAN PEGAWAI TELADAN PERIODE TAHUN 2023 PADA PENGADILAN MILITER I-05 PONTIANAK
