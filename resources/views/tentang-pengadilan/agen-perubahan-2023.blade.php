                            ...
                            <article class="article">
                                ...
                                <div class="container-header">
                                    <div class="title-container">
                                        <h2>Agen Perubahan Tahun 2023</h2>
                                    </div>
                                </div>
                                ...
                                <div style="text-align: center;">
                                    <img src="img/perubahan-2023.jpg" alt="" class="img-fluid"
                                        style="max-width: 600px;"data-aos="fade-up" data-aos-delay="100">
                                </div>
                                <br>
                                <div style="text-align: center;">
                                    <img src="img/perubahan1-2023.jpg" alt="" class="img-fluid"
                                        style="max-width: 600px;" data-aos="fade-up" data-aos-delay="100">
                                </div>
                                ...
                                <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="300">
                                    ...
                                    <div>
                                        <h4><a href="https://drive.google.com/file/d/1YUvUA6d2FmE9SbI1fXzIXnmwMi3RhF5l/view"
                                                class="stretched-link">Tautan Link :</a></h4>
                                        <h4 class="highlight" style="border-radius: 8px; font-size:13px">KEPUTUSAN KEPALA
                                            PENGADILAN MILITER I-05 PONTIANAK NOMOR W1-MIL05/KEP/43/OT.00/V/2023 TANGGAL 9
                                            MEI 2023 TENTANG PEMBENTUKAN TIM AGEN PERUBAHAN TAHUN 2023 PENGADILAN MILITER
                                            I-05 PONTIANAK</h4>
                                    </div>
                                </div><!-- End Icon Box -->
                            </article>
