                                ...
                                <div class="row">
                                    <div class="col-lg-12 mt-3 mt-lg-0 d-flex flex-column justify-content-center">
                                        ...
                                        <ol type="1">
                                            ...
                                            <br>
                                            <li><strong>Monitoring dan Evaluasi Pembangunan ZI</strong>
                                                <ol type="a">
                                            ...
                                            <li><strong>Perubahan Pola Pikir dan Budaya Kerja</strong>
                                            ...
                                            <br>
                                            <li>
                                                <strong>Pembentukan Agen Perubahan
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mt-3 mt-lg-0 d-flex flex-column justify-content-center">
                                        <div class="icon-box d-flex position-relative" data-aos="fade-up"
                                            ...
                                            <div>
                                                <h4><a href="https://drive.google.com/file/d/1Wtujjg-4nL4QVmozhUg2ct6AdKJLk6Lw/view?usp=sharing"
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mt-3 mt-lg-0 d-flex flex-column justify-content-center">
                                        <div class="icon-box d-flex position-relative" data-aos="fade-up"
                                            ...
                                            <i class="bi bi-link-45deg flex-shrink-0"></i>
                                            <div>
                                                <h4><a href="https://drive.google.com/drive/folders/1I1LrcIjKM7GrgrihrIB2z4aQM-P6RjCt?usp=share_link"
                                                        class="stretched-link"></a></h4>
                                                <h4 class="highlight" style="border-radius: 8px; font-size:13px">
                                                    Silahkan Klik disini untuk mengunduh Data
                                                    Dukung Pengungkit Area 1 Manajemen Perubahan
                                                </h4>
                                            </div>
                                        ...
                                        <div class="icon-box d-flex position-relative" data-aos="fade-up"
                                            ...
                                            <i class="bi bi-link-45deg flex-shrink-0"></i>
                                            <div>
                                                <h4><a href="https://drive.google.com/drive/folders/1fTydywNUrhdDuCjXCJN2i5tAPct-PVUK?usp=share_link"
                                                        class="stretched-link"></a></h4>
                                                <h4 class="highlight" style="border-radius: 8px; font-size:13px">
                                                    Silahkan klik disini untuk mengunduh Dokumen
                                                    Reform Area 1 Manajemen Perubahan
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
