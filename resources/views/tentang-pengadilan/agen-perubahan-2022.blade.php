                            ...
                            <article class="article">
                                ...
                                <div class="container-header">
                                    <div class="title-container">
                                        <h2>Agen Perubahan Tahun 2022</h2>
                                    </div>
                                </div>
                                ...
                                <div style="text-align: center;">
                                    <img src="img/perubahan-2022.png" alt="" class="img-fluid" style="max-width: 600px;"data-aos="fade-up" data-aos-delay="100">
                                  </div>
                                  <br>
                                  <div style="text-align: center;">
                                    <img src="img/perubahan1-2022.jpg" alt="" class="img-fluid" style="max-width: 600px;" data-aos="fade-up" data-aos-delay="100">
                                  </div>

                                  <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="300">
                                    <i class="bi bi-link-45deg flex-shrink-0"></i>
                                    <div>
                                        <h4><a href="https://drive.google.com/file/d/1Y7RUMJEzrcOmXXn2eLM7y1PbN7y5X1yF/view" class="stretched-link">Tautan Link :</a></h4>
                                        <h4 class="highlight" style="border-radius: 8px; font-size:13px">KEPUTUSAN PLT. KEPALA PENGADILAN MILITER I-05 PONTIANAK NOMOR W1-MIL05/KEP /33/OT.01.1/II/2022 TANGGAL 2 PEBRUARI 2022 TENTANG PEMBENTUKAN TIM AGEN PERUBAHAN TAHUN 2022 PENGADILAN MILITER I-05 PONTIANAK</h4>
                                    </div>
                                </div><!-- End Icon Box -->
                            </article>
