                                ...
                                <div class="row">
                                    <div class="col-lg-12 mt-3 mt-lg-0 d-flex flex-column justify-content-center">
                                        <div class="icon-box d-flex position-relative" data-aos="fade-up"
                                            ...
                                            <div>
                                                <h4><a href="https://drive.google.com/file/d/1n46y2bPQkpmCCP-z1jamPXw208Kt5sFG/view"
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mt-3 mt-lg-0 d-flex flex-column justify-content-center">
                                        <div class="icon-box d-flex position-relative" data-aos="fade-up"
                                            ...
                                            <i class="bi bi-link-45deg flex-shrink-0"></i>
                                            <div>
                                                <h4><a href="https://drive.google.com/drive/folders/1IOpqSi30Q_NdiK7bVAatUPtQoUEVYW40"
                                                        class="stretched-link"></a></h4>
                                                <h4 class="highlight" style="border-radius: 8px; font-size:13px">
                                                    Silahkan Klik disini untuk mengunduh Data Dukung Pengungkit Area 6 Peningkatan Pelayanan Publik
                                                </h4>
                                            </div>
                                        ...
                                        <div class="icon-box d-flex position-relative" data-aos="fade-up"
                                            ...
                                            <i class="bi bi-link-45deg flex-shrink-0"></i>
                                            <div>
                                                <h4><a href="https://drive.google.com/drive/folders/1fVuel1XFgAtvL_FDsNJiP_9eXgBVxOfy"
                                                        class="stretched-link"></a></h4>
                                                <h4 class="highlight" style="border-radius: 8px; font-size:13px">
                                                    Silahkan klik disini untuk mengunduh Dokumen Reform Area 6 Peningkatan pelayanan Publik
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
