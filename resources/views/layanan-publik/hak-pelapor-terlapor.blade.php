                            ...
                            <article class="article">
                                ...
                                <div class="container-header">
                                    <div class="title-container">
                                        <h2>Hak-Hak Pelapor dan Terlapor</h2>
                                    </div>
                                </div>

                                <div class="content">
                                    <br>
                                    <p>Berdasarkan Surat Keputusan Mahkamah Agung RI Nomor : 076/KMA/SK/VI/2009 tentang
                                        Pedoman Pelaksanaan Penanganan Pengaduan di Lingkungan Lembaga Peradilan.</p>
                                    </p>
                                    ...
                                    <ol type="a">
                                        ...
                                        <li>Mendapatkan kesempatan untuk memberikan keterangan secara bebas tanpa paksaan dari pihak manapun.</li>
                                        <li>Mendapatkan informasi mengenai tahapan laporan pengaduan yang didaftarkan.</li>
                                        <li>Mendapatkan perlakuan yang sama dan setara dengan Terlapor dalam pemeriksaan.</li>
                                    </ol>
                                    </p>

                                    <p>
                                        <b>Hak-Hak Terlapor</b>
                                        <ol type="a">
