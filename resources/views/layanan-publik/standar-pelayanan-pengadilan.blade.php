                            ...
                            <article class="article">
                                ...
                                <div class="container-header">
                                    <div class="title-container">
                                        <h2>Standar Pelayanan Pengadilan I-05 Pontianak</h2>
                                    </div>
                                </div>
                                ...
                                <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="300">
                                    ...
                                    <div>
                                        <h4><a href="https://drive.google.com/file/d/1lI6-paFfdViJ2jHnaU4vlKhkmgWT4ovI/view"
                                                class="stretched-link">Tautan Link :</a></h4>
                                        <h4 class="highlight" style="border-radius: 8px; font-size:13px">KEPUTUSAN KEPALA
                                            PENGADILAN MILITER I-05 PONTIANAK NOMOR 40/KPM.W1-MIL05/SK.OT1.2/I/2024 TANGGAL
                                            31 JANUARI 2024 TENTANG PEMBENTUKAN TIM AGEN PERUBAHAN TAHUN 2024 PENGADILAN
                                            MILITER I-05 PONTIANAK</h4>
                                    </div>
                                </div><!-- End Icon Box -->
                                ...
                                <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="300">
                                    <i class="bi bi-link-45deg flex-shrink-0"></i>
                                    <div>
                                        <h4><a href="https://drive.google.com/file/d/1ayC605ZY9rgW5VX3sf3XW8NcI3QpuhXu/view"
                                                class="stretched-link">Tautan Link :</a></h4>
                                        <h4 class="highlight" style="border-radius: 8px; font-size:13px">KEPUTUSAN KEPALA
                                            PENGADILAN MILITER I-05 PONTIANAK TENTANG STANDAR PELAYANAN PENGADILAN MILITER
                                            I-05 PONTIANAK</h4>
                                    </div>
                                </div><!-- End Icon Box -->
                                <br>
                                <div style="text-align: center;" data-aos="fade-up" data-aos-delay="100">
                                    <img src="img/spp.jpg" alt="" class="img-fluid">
                                </div>
